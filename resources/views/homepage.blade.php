...
@section('content')
        ...
        <div class="mt-4">
            <a href="{{url('/form')}}" role="button" class="btn btn-lg btn-block btn-outline-success rounded-pill shadow-lg p-3 mb-5"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-emoji-laughing" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mt-4">
            <a href="{{url('/report')}}" role="button" class="btn btn-outline-danger btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
                ...
                รายงานการรับเรื่อง</a>
        </div>
        <div class="mt-4">
            <a href="{{url('/status')}}" role="button" class="btn btn-outline-warning btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
        ...
        <div class="mt-4">
            <a href="{{url('/success')}}" role="button" class="btn btn-outline-primary btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
                ...
                รายงานที่เสร็จสิ้น</a>
        </div>
        <div class="mt-4">
            <a href="{{url('/approve')}}" role="button" class="btn btn-outline-dark btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
