...
@section('content')
        ...
        <div class="mt-4">
            <a href="{{url('/status')}}" role="button" class="btn btn-outline-primary btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
        ...
        <div class="mt-4">
            <a href="{{url('/success')}}" role="button" class="btn btn-outline-dark btn-block btn-lg rounded-pill shadow-lg p-3 mb-5">
